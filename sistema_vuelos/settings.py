"""
Django settings for sistema_vuelos project.
...
SECRET_KEY = 'django-insecure-^$^gm(ed2r0*6@can%9$ygxix-7^@9bg!*1$*9%awbqcf1g#$f'
...
ROOT_URLCONF = 'sistema_vuelos.urls'
...
WSGI_APPLICATION = 'sistema_vuelos.wsgi.application'
